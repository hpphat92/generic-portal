...
export interface CustomObjectResultListEventDTO {
    value?: Array<EventDTO>;
    declaredType?: string;
    statusCode?: CustomObjectResultListEventDTO.StatusCodeEnum;
}
export namespace CustomObjectResultListEventDTO {
