...
export interface CustomObjectResultListPlaceDTO {
    value?: Array<PlaceDTO>;
    declaredType?: string;
    statusCode?: CustomObjectResultListPlaceDTO.StatusCodeEnum;
}
export namespace CustomObjectResultListPlaceDTO {
